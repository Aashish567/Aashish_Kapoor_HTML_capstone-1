...
function Navigation() {
  ...
  return (
    ...
    <nav style={navbar} className="navbar navbar-expand-lg bg-body-tertiary">
  <div className="container-fluid">
    ...
    <div style={{marginLeft:"50px"}} className="collapse navbar-collapse" id="navbarSupportedContent">
      <ul className="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li className="nav-item">
          <Link className="nav-link active" to="/favourites">Favorites</Link>
        </li>
        <li className="nav-item">
      ...
      <form className="d-flex">
        ...
        <li className="nav-item">
          <Link className="nav-link active" aria-current="page" to="/cart">My Cart</Link>
        </li>
        </ul>
